...
function loadSettings(jsonObject) {
    ...
    if($("#siteName").length > 0) {
        ...
        //$("#wifiWakeUp").val(jsonObject.wifiWakeUp);
...
function confirmSettings() {
    ...
    // Wifi wake up disabled in this version
    // if(wifiWakeUp === "On") {
...
// Wifi wake up disabled in this version 
// function wifiWakeUpWarning() {
//     $("#modalTitleText").text("WiFi WakeUp");
//     $("#modalDescText").text("Enabling WiFi wakeup will cause your iTracker to wake up and broadcast wifi on a 5 minute interval. This will cause a significant decrease in battery life."); 
    
//     // If confirmed wait 1 second, then call confirmSettings to move to the next step 
//     $("#confirmButton").click(function(){ 
//         setTimeout(() => {
//             confirmSettings(1);
//         }, 1000);
...
function pipeSizeWarning() {
    $("#modalTitleText").text("Pipe Size");
    $("#modalDescText").text("For accuracy, a one time velocity measurement is recommended. See Manual or contact Eastech."); 
